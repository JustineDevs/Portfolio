...
async function seedPageSections() {
  const sections = [
    ...
    {
      pageKey: "about",
      sectionKey: "reading_map",
      title: legacyAboutSections.readingMap.heading,
      subtitle: legacyAboutSections.readingMap.subheading,
      bodyMd: legacyAboutSections.readingMap.dateLabel,
      metaJson: JSON.stringify({ panels: legacyAboutSections.readingMap.panels }),
      sortOrder: 1,
    },
    {
      pageKey: "about",
      sectionKey: "narrative",
      title: legacyAboutSections.narrative.title,
      subtitle: null,
      bodyMd: legacyAboutSections.narrative.body,
      metaJson: null,
      sortOrder: 2,
    },
    {
      ...
      title: legacyAboutSections.principles.title,
      subtitle: null,
      bodyMd: legacyAboutSections.principles.body,
      metaJson: null,
      sortOrder: 3,
    },
    {
      pageKey: "about",
      sectionKey: "learning",
      title: legacyAboutSections.learning.title,
      subtitle: null,
      bodyMd: legacyAboutSections.learning.body,
      metaJson: null,
      sortOrder: 4,
    },
    {
      pageKey: "about",
      sectionKey: "under_the_hood",
      title: legacyAboutSections.underTheHood.title,
      subtitle: null,
      bodyMd: legacyAboutSections.underTheHood.body,
      metaJson: null,
      sortOrder: 5,
    },
    {
      pageKey: "about",
      sectionKey: "north_star",
      title: legacyAboutSections.northStar.title,
      subtitle: null,
      bodyMd: legacyAboutSections.northStar.body,
      metaJson: null,
      sortOrder: 6,
    },
  ];
